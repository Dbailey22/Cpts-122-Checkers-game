...
int main()
{
			...
			cout << "Once you have jumped a piece you will then remove the piece that was jumped by left clicking on it \nand then right clicking on it\n" << endl;
			cout << "If a piece makes it to the opposite side of the board you will be allowed to make it a king!\n You do this by clicking on the piece and clicking space\n" << endl;
